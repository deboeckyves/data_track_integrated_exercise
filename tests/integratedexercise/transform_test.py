...
def test_transform_add_city_column(spark):
    ...
    df_input = spark.createDataFrame([
        # ('40OB02 - Wielsbeke',3.376211631,50.914952961),
        # ('43N121 - Offagne',5.202387467,49.877128491),
        # ('43R240 - Engis',5.39744605,50.583614347),
        ('40OB01 - Oostrozebeke',3.307385799,50.917228441),
        # ('43N132 - Habay-La-Neuve',5.630397741,49.719281188),
        # ('44N052 - Zwevegem',3.322494319,50.81487387),
        # ('43N093 - Sinsin',5.235168655,50.274477511),
        # ('43N100 - Dourbes',4.594762762,50.095683434),
        # ('41MEU1 - Meudon',4.395716787,50.895001011),
        # ('43N113 - Sainte-Ode',5.593016914,50.027029017),
        # ('43N085 - Vielsalm',6.001736289,50.303207828),
        # ('43N067 - Membach',5.992752719,50.612277528),
    ], schema=StructType(df_input_fields))

    df_expected_output = spark.createDataFrame([
        # ('40OB02 - Wielsbeke',3.376211631,50.914952961, "Wielsbeke"),
        # ('43N121 - Offagne',5.202387467,49.877128491, ""),
        # ('43R240 - Engis',5.39744605,50.583614347, ""),
        ('40OB01 - Oostrozebeke',3.307385799,50.917228441, "Oostrozebeke"),
        # ('43N132 - Habay-La-Neuve',5.630397741,49.719281188, ""),
        # ('44N052 - Zwevegem',3.322494319,50.81487387, ""),
        # ('43N093 - Sinsin',5.235168655,50.274477511, ""),
        # ('43N100 - Dourbes',4.594762762,50.095683434, ""),
